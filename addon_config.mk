...
meta:
	ADDON_NAME = santiNodes
	ADDON_DESCRIPTION = Audio and event modules for ofxOceanode
	ADDON_AUTHOR = @PlaymodesStudio
	ADDON_TAGS = "santiNodes" "Audio" "Events"
	ADDON_URL = https://github.com/PlaymodesStudio/santiNodes
